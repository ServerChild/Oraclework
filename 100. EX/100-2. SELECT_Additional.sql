...
-- 풀이 1
SELECT DEPARTMENT_NO "학과 번호", COUNT(DECODE(ABSENCE_YN, 'Y', 'Y')) "휴학생 수" FROM TB_STUDENT
GROUP BY DEPARTMENT_NO ORDER BY 1;

-- 풀이 2
SELECT DEPARTMENT_NO 학과번호, COUNT(DECODE(ABSENCE_YN, 'Y', 1)) "휴학생 수" FROM TB_STUDENT
