...
SELECT EMP_NAME, SALARY * 12, (SALARY + (SALARY * BONUS)) * 12, (((SALARY + (SALARY * BONUS)) * 12) - (SALARY * 0.3)) 
FROM EMPLOYEE;
...
SELECT EMP_NAME, (((SALARY + (SALARY * BONUS)) * 12) - (SALARY * 0.3)), HIRE_DATE FROM EMPLOYEE
WHERE (((SALARY + (SALARY * BONUS)) * 12) - (SALARY * 0.3)) >= 50000000;
