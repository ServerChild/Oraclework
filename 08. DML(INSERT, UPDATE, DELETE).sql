...
/*
    < INSERT >
        ...
        - 표현식 : INSERT INTO 테이블명 VALUES(값1, 값2, 값3,...)
            -> 테이블의 모든 컬럼에 값을 직접 넣어 한 행을 넣고자 할때 컬럼의 순서대로 VALUES에 값을 넣음
                 + 부족하게 값을 넣었을 때 => not enough value오류
                 + 값을 더 많이 넣었을 때 => too many values오류
*/
INSERT INTO EMPLOYEE VALUES(300, '김아무개', '051117-1234567', 'qwe@elk.or.kr', '01023456789'
                                                        , 'D1', 'J5', 3500000, 0.2, 200, SYSDATE, NULL, DEFAULT);
    
    
-- 값이 많거나 적으면 오류                                                    
INSERT INTO EMPLOYEE VALUES(301, '이아무개', '051117-1234567', 'qwer@elk.or.kr', '01023456789'
...
--------------------------------------------------------------------------------
/*
    < INSERT ALL > : 두개 이상의 테이블에 각각 INSERT할 때
